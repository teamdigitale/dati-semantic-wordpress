...
use ERROPiX\AdvancedScripts\ScssCompiler\Base\Range;
use ERROPiX\AdvancedScripts\ScssCompiler\Block\AtRootBlock;
use ERROPiX\AdvancedScripts\ScssCompiler\Block\CallableBlock;
use ERROPiX\AdvancedScripts\ScssCompiler\Block\DirectiveBlock;
use ERROPiX\AdvancedScripts\ScssCompiler\Block\EachBlock;
use ERROPiX\AdvancedScripts\ScssCompiler\Block\ElseBlock;
use ERROPiX\AdvancedScripts\ScssCompiler\Block\ElseifBlock;
use ERROPiX\AdvancedScripts\ScssCompiler\Block\ForBlock;
use ERROPiX\AdvancedScripts\ScssCompiler\Block\IfBlock;
use ERROPiX\AdvancedScripts\ScssCompiler\Block\MediaBlock;
use ERROPiX\AdvancedScripts\ScssCompiler\Block\NestedPropertyBlock;
use ERROPiX\AdvancedScripts\ScssCompiler\Block\WhileBlock;
use ERROPiX\AdvancedScripts\ScssCompiler\Compiler\CachedResult;
use ERROPiX\AdvancedScripts\ScssCompiler\Compiler\Environment;
use ERROPiX\AdvancedScripts\ScssCompiler\Exception\CompilerException;
use ERROPiX\AdvancedScripts\ScssCompiler\Exception\ParserException;
use ERROPiX\AdvancedScripts\ScssCompiler\Exception\SassException;
use ERROPiX\AdvancedScripts\ScssCompiler\Exception\SassScriptException;
use ERROPiX\AdvancedScripts\ScssCompiler\Formatter\Compressed;
use ERROPiX\AdvancedScripts\ScssCompiler\Formatter\Expanded;
use ERROPiX\AdvancedScripts\ScssCompiler\Formatter\OutputBlock;
use ERROPiX\AdvancedScripts\ScssCompiler\Logger\LoggerInterface;
use ERROPiX\AdvancedScripts\ScssCompiler\Logger\StreamLogger;
use ERROPiX\AdvancedScripts\ScssCompiler\Node\Number;
use ERROPiX\AdvancedScripts\ScssCompiler\SourceMap\SourceMapGenerator;
use ERROPiX\AdvancedScripts\ScssCompiler\Util\Path;
...
class Compiler
{
    ...
    /**
     * @var \ERROPiX\AdvancedScripts\ScssCompiler\Compiler\Environment
     */
    protected $env;
    /**
     * @var OutputBlock|null
     ...
     * @param string|null $path
     *
     * @return \ERROPiX\AdvancedScripts\ScssCompiler\Parser
     */
     ...
     *
     * @return \ERROPiX\AdvancedScripts\ScssCompiler\Formatter\OutputBlock
     */
     ...
     * Compile root
     *
     * @param \ERROPiX\AdvancedScripts\ScssCompiler\Block $rootBlock
     *
     * @return void
     */
     ...
     * Flatten selectors
     *
     * @param \ERROPiX\AdvancedScripts\ScssCompiler\Formatter\OutputBlock $block
     ...
     * Compile media
     *
     * @param \ERROPiX\AdvancedScripts\ScssCompiler\Block $media
     *
     * @return void
     */
     ...
     * Media parent
     *
     * @param \ERROPiX\AdvancedScripts\ScssCompiler\Formatter\OutputBlock $scope
     *
     * @return \ERROPiX\AdvancedScripts\ScssCompiler\Formatter\OutputBlock
     */
     ...
     * @param \ERROPiX\AdvancedScripts\ScssCompiler\Formatter\OutputBlock $out
     *
     * @return void
     */
     ...
     * Compile at-root
     *
     * @param \ERROPiX\AdvancedScripts\ScssCompiler\Block $block
     *
     * @return void
     */
     ...
     *
     * @param \ERROPiX\AdvancedScripts\ScssCompiler\Formatter\OutputBlock $scope
     * @param \ERROPiX\AdvancedScripts\ScssCompiler\Formatter\OutputBlock $previousScope
     *
     * @return OutputBlock
     */
     ...
     * Filter WITH rules
     *
     * @param \ERROPiX\AdvancedScripts\ScssCompiler\Block|\ERROPiX\AdvancedScripts\ScssCompiler\Formatter\OutputBlock $block
     * @param array                                                         $with
     * @param array                                                         $without
     *
     * @return bool
     ...
     * @param array[]                                $stms
     * @param \ERROPiX\AdvancedScripts\ScssCompiler\Formatter\OutputBlock $out
     * @param \ERROPiX\AdvancedScripts\ScssCompiler\Block                 $selfParent
     * @param string                                 $traceName
     *
     * @return void
     *
...
EOL;
     ...
     *
     * @param \ERROPiX\AdvancedScripts\ScssCompiler\Compiler\Environment $env
     * @param \ERROPiX\AdvancedScripts\ScssCompiler\Block                $selfParent
     *
     * @return array
     */
     ...
     * @param \ERROPiX\AdvancedScripts\ScssCompiler\Block $block
     *
     * @return \ERROPiX\AdvancedScripts\ScssCompiler\Compiler\Environment
     */
    ...
    public function addVariables(array $variables)
    {
        ...
        if ($triggerWarning) {
            @trigger_error('Passing raw values to as custom variables to the Compiler is deprecated. Use "\ERROPiX\AdvancedScripts\ScssCompiler\ValueConverter::parseValue" or "\ERROPiX\AdvancedScripts\ScssCompiler\ValueConverter::fromPhp" to convert them instead.', E_USER_DEPRECATED);
        }
    }
     ...
     *
     * @return \ERROPiX\AdvancedScripts\ScssCompiler\Compiler
     *
     ...
     * @return never
     *
     * @throws \ERROPiX\AdvancedScripts\ScssCompiler\Exception\CompilerException
     *
