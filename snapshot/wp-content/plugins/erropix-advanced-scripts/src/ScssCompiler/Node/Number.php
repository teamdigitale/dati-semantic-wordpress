...
class Number extends Node implements \ArrayAccess
{
     ...
     * Output number
     *
     * @param \ERROPiX\AdvancedScripts\ScssCompiler\Compiler $compiler
     *
     * @return string
     */
