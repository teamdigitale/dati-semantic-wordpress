...
use ERROPiX\AdvancedScripts\ScssCompiler\Block\ContentBlock;
...
use ERROPiX\AdvancedScripts\ScssCompiler\Logger\QuietLogger;
...
class Parser
{
        ...
        if (
            ...
            if ($value === [Type::T_SELF]) {
                ...
                if ($lookWhite) {
                    ...
                    $right = (!empty($this->buffer[$this->count]) &&
    ...
    protected function selectors(&$out, $subSelector = false)
    {
        ...
        while ($this->selector($sel, $subSelector)) {
            ...
            while ($this->matchChar(',', true)) {; // ignore extra
            }
        }
