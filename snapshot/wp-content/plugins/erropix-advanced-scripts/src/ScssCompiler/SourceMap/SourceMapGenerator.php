...
namespace ERROPiX\AdvancedScripts\ScssCompiler\SourceMap;
...
class SourceMapGenerator
{
     ...
     *
     * @var \ERROPiX\AdvancedScripts\ScssCompiler\SourceMap\Base64VLQ
     */
    protected $encoder;
     ...
     * @return string|null
     *
     * @throws \ERROPiX\AdvancedScripts\ScssCompiler\Exception\CompilerException If the file could not be saved
     * @deprecated
     */
